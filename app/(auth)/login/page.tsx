      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[var(--ink)] p-16 flex-col justify-between">
        ...
        <div>
          ...
          <p className="text-[var(--stone)] leading-relaxed">
            Sign in to continue connecting with architects and clients.
          </p>
        </div>
        ...
        <div className="w-full max-w-md">
          <div className="lg:hidden mb-10">
            <Link href="/" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none" }}>
              ...
              <span className="display text-3xl">ArchLink</span>
            </Link>
          </div>
          ...
          <p className="text-[var(--stone)] text-sm mb-10">
            No account?{" "}
            <Link href="/signup" className="text-[var(--terracotta)] hover:underline">Create one</Link>
          </p>
